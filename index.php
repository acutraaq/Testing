...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | COVID-19 Occupancy Counter</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'sensorlog')? 'active' : '' ?>" href="./?page=sensorlog">Sensor Log</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="./realtime.php" target="_blank">Realtime Occupancy</a>
                    </li>
